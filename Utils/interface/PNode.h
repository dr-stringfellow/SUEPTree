...
struct PNode {
  ...
  /*!
   * Pruning can be configured by defining gPruningFunction.
   * By default, each of the following daughter d is removed from the daughters list:
